...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='authormodel_createdby', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='authormodel',
            name='created_on',
        ...
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bookmodel_createdby', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='bookmodel',
            name='created_on',
        ...
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='categorymodel_createdby', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='categorymodel',
            name='created_on',
        ...
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='publishermodel_createdby', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='publishermodel',
            name='created_on',
