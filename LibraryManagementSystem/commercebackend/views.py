...
from .models import BookModel, CartItemModel, CartModel, OrderModel, ShippingModel
...
class OrderView(
    viewsets.GenericViewSet, viewsets.mixins.RetrieveModelMixin, viewsets.mixins.ListModelMixin
):
