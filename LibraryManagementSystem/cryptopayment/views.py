...
class CreateQRPayment(viewsets.GenericViewSet,
    ...
    def create(self, request):
        ...
        try:
            ...
            return Response(data={"detail" : "Can't create qr code for the payment, user doesn't have a shipping address"}, status=status.HTTP_400_BAD_REQUEST)
        ...
        try:
            ...
            payment = Payment.objects.create(btc_address_wif=key.to_wif(), 
                               ...
                               qr_image=str(img_name), shipping=shipping)
